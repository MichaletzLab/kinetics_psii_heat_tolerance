...
# per-figure NEE source-data workbooks by convert_source_data.R. NEE requires
...
# tree3 tip labels are "Genus_species"; match that (source species use spaces)
...
##### Figure 2c
#Is there a diff in alopwa between proteins and psii?
