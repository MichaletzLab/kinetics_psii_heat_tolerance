...
leaf_data_all <- read.csv("data/Bison_Source_Data_Fig2_a_b_c_d.csv")
...
#### Fig 2c ####
protein_only <- read.csv("data/Bison_Source_Data_Fig2_c.csv")
...
##### Fig 2e ####
lit_review<-read.csv("./data/Bison_Source_Data_Fig2_e_f.csv")
...
####### Figure 3 ####### NEEEDS UPDATING
#Load kinetics, heat tolerance data from seasonal dataset 
df_seasons<-read.csv("./data/Bison_Source_Data_Fig3_a_c_e_g.csv")
df_seasons$season <- factor(df_seasons$season, levels = c("spring","summer","fall"))

#Load climate data
df_seasons_climate <- read.csv("data/Bison_Source_Data_Fig3_b_d_f.csv")
...
#### Table 1####
leaf_proteins_lipids <- read.csv("data/Bison_Source_Data_ED_Table1.csv")
...
##### Table 4 #######
climate_raw <- read.csv("data/Bison_Source_Data_ED_Table4.csv")
...
##### Table 5 #######
prothermdb_a_thaliana_hsp <- read.csv("data/Bison_Source_Data_ED_Table5.csv")
...
#### Figure  3####
d <- read.csv("data/Bison_Source_Data_ED_Fig3_traits.csv")
...
trait <- setNames(leaf_data_all$ea_kJ_mol, c(leaf_data_all$species))
